...
private class ExampleClientRPC {
    companion object {
        ...
        private fun logState(state: StateAndRef<InsuranceState>) = logger.info("{}", state.state.data)
    }
    ...
    fun main(args: Array<String>) {
        ...
        val (snapshot, updates) = proxy.vaultTrack(InsuranceState::class.java)

        // Log the 'placed' Insurance states and listen for new ones.
