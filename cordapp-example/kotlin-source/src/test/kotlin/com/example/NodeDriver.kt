...
fun main(args: Array<String>) {
    ...
    driver(isDebug = true) {
        ...
        val (nodeA, nodeB, nodeC,nodeD) = listOf(
                startNode(providedName = CordaX500Name("HospitalA", "London", "GB"), rpcUsers = listOf(user)),
                startNode(providedName = CordaX500Name("InsuranceB", "New York", "US"), rpcUsers = listOf(user)),
                startNode(providedName = CordaX500Name("InsuranceC", "New York", "US"), rpcUsers = listOf(user)),
                startNode(providedName = CordaX500Name("InsuranceD", "Paris", "FR"), rpcUsers = listOf(user))).map { it.getOrThrow() }
